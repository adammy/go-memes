...
type Config struct {
	...
	ImageRepositoryType imageold.GetterType `mapstructure:"image_repository_type"`
	...
	UploaderType imageold.UploaderType `mapstructure:"uploader_type"`
}
...
func LoadConfig(path, env string) (*Config, error) {
	...
	viper.SetDefault("meme.image_repository_type", imageold.LocalGetter)
	...
	viper.SetDefault("meme.uploader_type", imageold.LocalUploader)
