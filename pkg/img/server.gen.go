...
type ServerInterface interface {
	...
	// DeleteImage deletes the requested Image.
	// (DELETE /images/{imageID})
	DeleteImage(w http.ResponseWriter, r *http.Request, imageID string)

	// GetImage retrieves the requested Image.
	// (GET /images/{imageID})
...
func (siw *ServerInterfaceWrapper) DeleteImage(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithLocation("simple", false, "imageID", runtime.ParamLocationPath, chi.URLParam(r, "imageID"), &imageID)
	if err != nil {
