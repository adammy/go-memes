...
type ServerInterface interface {
	...
	DeleteTemplate(w http.ResponseWriter, r *http.Request, templateID string)

	// GetTemplate retrieves the requested Template.
	// (GET /templates/{templateID})
	GetTemplate(w http.ResponseWriter, r *http.Request, templateID string)

	// UpdateTemplate updates the requested Template.
	// (PUT /templates/{templateID})
	UpdateTemplate(w http.ResponseWriter, r *http.Request, templateID string)
...
func (siw *ServerInterfaceWrapper) DeleteTemplate(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithLocation("simple", false, "templateID", runtime.ParamLocationPath, chi.URLParam(r, "templateID"), &templateID)
	if err != nil {
